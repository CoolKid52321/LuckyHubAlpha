--// Current Source was all made by dual#6723
...
https://raw.githubusercontent.com/CoolKid52321/Lololool/main/MAINLOL.lua
...
library.theme = {
    ...
    bordercolor = Color3.fromRGB(221, 164, 0),
    accentcolor = Color3.fromRGB(185, 138, 0),
    accentcolor2 = Color3.fromRGB(232, 185, 49),
    ...
    itemscolor = Color3.fromRGB(212, 157, 0),
...
function library:CreateWatermark(name, position)
    ...
    watermark.mainbar.BorderColor3 = Color3.fromRGB(218, 152, 0)
...
local Window = library:CreateWindow("LuckyHub", Vector2.new(492, 592), Enum.KeyCode.RightShift) 
...
dotenabled:AddColorpicker(Color3.fromRGB(218, 152, 0), function(ztx)
...
highlighxdxdxd:AddColorpicker(Color3.fromRGB(218, 152, 0), function(ztx)
    fillcolorxd = ztx
end)

highlighxdxdxd:AddColorpicker(Color3.fromRGB(198, 132, 0), function(ztx)
